    ...
    <>
      <nav>
        <div className="nav-left">
          <Link href="/work" className={router.pathname === '/work' ? 'active' : ''}>
            Work
          </Link>
          <Link href="/about" className={router.pathname === '/about' ? 'active' : ''}>
            About
          </Link>
          <Link href="/uses" className={router.pathname === '/uses' ? 'active' : ''}>
            Uses
          </Link>
        </div>
        ...
        <div className="nav-right">
          <Link href="/now" className={router.pathname === '/now' ? 'active' : ''}>
            Now
          </Link>
